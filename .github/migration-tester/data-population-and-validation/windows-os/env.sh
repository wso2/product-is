...
exportDEPLOYMENT_AUTOMATION_MYSQL="/home/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/deployment.toml"

# Absolute path to the postgre-ubuntu deployment file in migration-tester/migration-automation folder
exportDEPLOYMENT_AUTOMATION_MYSQL_POSTGRE_UBUNTU="/home/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/deploymentpostgres.toml" 

# Absolute path to the mssql-ubuntu deployment file in migration-tester/migration-automation folder
exportDEPLOYMENT_AUTOMATION_MYSQL_MSSQL_UBUNTU="/home/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/deploymentmssql.toml" 
...
export MIGRATION_RESOURCES_NEW_IS="/home/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/IS_HOME_NEW/migratingVersion/migration-resources"

# Absolute path to migration config.yaml file in new IS
export MIGRATION_CONFIG_YAML="/home/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/IS_HOME_NEW/migratingVersion/migration-resources/migration-config.yaml"
...
# Absolute path to the mysql-ubuntu deployment file in migration-tester/migration-automation folder
exportDEPLOYMENT_AUTOMATION_MYSQL_MAC="/Users/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/deployment-toml-mac-with-mysql.toml"

# Absolute path to the postgre-ubuntu deployment file in migration-tester/migration-automation folder
exportDEPLOYMENT_AUTOMATION_MYSQL_POSTGRE_MAC="/Users/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/deploymentpostgres.toml" 

# Absolute path to the mssql-ubuntu deployment file in migration-tester/migration-automation folder
exportDEPLOYMENT_AUTOMATION_MYSQL_MSSQL_MAC="/Users/runner/work/Automating-Product-Migration-Testing/Automating-Product-Migration-Testing/migration-tester/migration-automation/deploymentmssql.toml" 
