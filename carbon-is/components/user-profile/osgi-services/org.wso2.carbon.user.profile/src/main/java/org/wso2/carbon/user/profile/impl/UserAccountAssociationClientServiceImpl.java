 ...
 */
public class UserAccountAssociationClientServiceImpl implements UserAccountAssociationClientService {

    private static final Logger logger = LoggerFactory.getLogger(UserAccountAssociationClientServiceImpl.class);
    ...
    @Override
    public User addUserAssociation(User primaryUser, User associatedUser) throws UserProfileManagementException {
        if (primaryUser == null) {
            throw new UserProfileManagementException("The primary user is null");
        }
    ...
    @Override
    public User removeUserAssociation(User primaryUser, User associatedUser) throws UserProfileManagementException {
        if (primaryUser == null) {
            throw new UserProfileManagementException("The primary user is null");
        }
        if (associatedUser == null) {
