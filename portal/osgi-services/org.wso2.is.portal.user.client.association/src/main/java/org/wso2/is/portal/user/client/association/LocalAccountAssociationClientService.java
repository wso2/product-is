 ...
 */
public interface LocalAccountAssociationClientService {
     ...
     * @throws UserAccountAssociationException when there is any error in adding the association.
     */
    User addUserAssociation(User primaryUser, User associatedUser) throws UserAccountAssociationException;
     ...
     * @return
     * @throws UserAccountAssociationException when there is any error in removing the user association.
     */
    User removeUserAssociation(User primaryUser, User associatedUser) throws UserAccountAssociationException;
