...
public interface IdentityStoreClientService {
     ...
     * @throws UserPortalUIException
     */
    GroupBean addGroup(org.wso2.carbon.identity.mgt.bean.GroupBean group, String domainName)
            throws UserPortalUIException;
     ...
     * @throws UserPortalUIException
     */
    GroupBean addGroup(Map<String, String> groupClaims, String domainName) throws UserPortalUIException;
