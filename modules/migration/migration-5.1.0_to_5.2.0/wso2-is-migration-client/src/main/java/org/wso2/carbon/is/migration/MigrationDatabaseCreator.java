...
public class MigrationDatabaseCreator {
    ...
    public void executeIdentityMigrationScript() throws Exception {
        ...
        try {
            log.info("--------------- EXECUTE IDENTITY MIGRATION SCRIPTS--------------");
            ...
            String dbscriptName = getIdentityDbScriptLocation(databaseType, Constants.VERSION_5_1_0, Constants
                    .VERSION_5_2_0);
    ...
    public void executeUmMigrationScript() throws Exception {
        ...
        try {
            log.info("--------------- EXECUTE UM MIGRATION SCRIPTS--------------");
            ...
            String dbscriptName = getUmDbScriptLocation(databaseType, Constants.VERSION_5_1_0, Constants.VERSION_5_2_0);
            executeSQLScript(dbscriptName);
            conn.commit();
            if (log.isTraceEnabled()) {
                log.trace("Migration script executed successfully.");
    ...
    protected String getIdentityDbScriptLocation(String databaseType, String from, String to) {
        ...
        if (Constants.VERSION_5_1_0.equals(from) && Constants.VERSION_5_2_0.equals(to)) {
            return carbonHome + File.separator + "dbscripts" + File.separator + "identity" + File.separator +
                    "migration-5.1.0_to_5.2.0" + File.separator + scriptName;
        } else {
    ...
    protected String getUmDbScriptLocation(String databaseType, String from, String to) {
        ...
        if (Constants.VERSION_5_1_0.equals(from) && Constants.VERSION_5_2_0.equals(to)) {
            return carbonHome + File.separator + "dbscripts" + File.separator + "migration-5.1.0_to_5.2.0" + File
