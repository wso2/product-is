...
import org.wso2.carbon.is.migration.service.v530.util.FileBasedClaimBuilder;
 ...
 */
public class ClaimDBMigrator implements ClaimMetadataStore {
    ...
    public ClaimDBMigrator(boolean continueOnError, boolean noBatchUpdate) {
