...
public class SQLConstants {
    ...
    public static final String ADD_CLAIM_DIALECT = "INSERT INTO IDN_CLAIM_DIALECT (DIALECT_URI, TENANT_ID) " +
            "VALUES (?, ?)";
    public static final String GET_CLAIM_DIALECT = "SELECT ID FROM IDN_CLAIM_DIALECT WHERE DIALECT_URI= ? AND TENANT_ID = ? ";
    ...
    public static final String GET_CLAIM_FROM_MAPPED_ATTRIBUTE = "SELECT LOCAL_CLAIM_ID FROM IDN_CLAIM_MAPPED_ATTRIBUTE " +
