...
UPDATE IDN_OAUTH_CONSUMER_APPS SET ID = nextval('IDN_OAUTH_CONSUMER_APPS_PK_SEQ');
...
ALTER TABLE IDN_AUTH_SESSION_STORE ALTER COLUMN TIME_CREATED TYPE BIGINT USING TIME_CREATED::BIGINT;
