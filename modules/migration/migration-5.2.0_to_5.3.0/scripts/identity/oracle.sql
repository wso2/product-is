...
/
CREATE OR REPLACE TRIGGER IDN_CLAIM_MAPPED_ATTRIBUTE_TRIG
BEFORE INSERT
...
CREATE TABLE IDN_CLAIM_MAPPING (
  ...
  CONSTRAINT EXT_TO_LOCAL_UNIQUE_MAPPING_CONSTRAINT UNIQUE (EXT_CLAIM_ID, TENANT_ID)
)
/
