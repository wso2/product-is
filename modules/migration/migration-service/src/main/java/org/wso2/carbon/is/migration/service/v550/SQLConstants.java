...
public class SQLConstants {
    ...
    public static final String RETRIEVE_ALL_TOKENS_WITH_HASHES = "SELECT ACCESS_TOKEN, REFRESH_TOKEN, TOKEN_ID, " +
    ...
    public static final String RETRIEVE_ALL_AUTHORIZATION_CODES_WITH_HASHES = "SELECT AUTHORIZATION_CODE, CODE_ID, " +
