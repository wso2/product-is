...
public abstract class UserMgtServiceAbstractTestCase extends ISIntegrationTest{
	...
	public void testListAllUsers() throws Exception {
    	Assert.assertTrue(nameExists(userMgtClient.listUsers("user1", 100), "user1"), "List all users has failed");
	}
	...
	public void testListUsers() throws Exception {
    	...
    	FlaggedName[] usersList = userMgtClient.listUsers("user1", 100);
...
//    	}
//
//    	userMgtClient.u("umRole1", userFlagList);
