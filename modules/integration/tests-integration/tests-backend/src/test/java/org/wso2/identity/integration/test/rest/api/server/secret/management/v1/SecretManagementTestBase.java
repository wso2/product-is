...
/**
 * Base test class for the Secret Management Rest APIs.
 */
public class SecretManagementTestBase extends RESTAPIServerTestBase {
    ...
    public static final String SECRET_TYPE = "adaptive-auth";
