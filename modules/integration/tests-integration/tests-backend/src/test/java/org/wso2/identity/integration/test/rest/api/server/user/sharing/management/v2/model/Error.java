...
@ApiModel(description = "Details of an error, including code, message, description, and a trace ID to help with " +
        "debugging.")
public class Error {
    ...
    @ApiModelProperty(example = "e0fbcfeb-7fc2-4b62-8b82-72d3c5fbcdeb", required = true,
            value = "A trace ID in UUID format to help with debugging.")
