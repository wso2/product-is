...
public class UserInformationRecoveryServiceTenantEmailUserTestCase extends ISIntegrationTest {
    ...
    private static final String TENANT_USER_PASSWORD = "passWord1@";
    private static final String USERNAME_CLAIM_URI = "http://wso2.org/claims/username";
    private static final String TENANT_DOMAIN = "inforecovery.com";
    private static final String TENANT_ADMIN_USERNAME = "admin@abc.com@inforecovery.com";
    private static final String TENANT_ADMIN_PASSWORD = "admin";
    private static final String TENANT_ADMIN_TENANT_AWARE_USERNAME = "admin@abc.com";
    ...
    public void testInit() throws Exception {
        ...
        tenantServiceClient.addTenant(TENANT_DOMAIN, TENANT_ADMIN_TENANT_AWARE_USERNAME, TENANT_ADMIN_PASSWORD,
                TENANT_ADMIN_TENANT_AWARE_USERNAME, "Info", "Recovery");
        ...
        userMgtClient.addUser(TENANT_USER, TENANT_USER_PASSWORD, null, profileName);
    }
