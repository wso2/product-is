...
public class OAuth2TokenSignatureAlgorithmTestCase extends OAuth2ServiceAbstractIntegrationTest {
    ...
    public void testAuthorizationContextValidateJwtToken() throws Exception {
        ...
        if (responseDTO != null && responseDTO.getAuthorizationContextToken() != null) {
            ...
            JSONObject jwtJsonObject = new JSONObject(new String(Base64.decodeBase64(tokenElements[0])));
            String signatureAlgo = jwtJsonObject.get(OAuth2Constant.JWT_SIGNATURE_ALGO_NAME).toString();
            Assert.assertTrue(signatureAlgo.equals("none"), "Signature algo is not valid");
    ...
    private void changeISConfiguration() throws Exception {
        ...
        File configuredIdentityXML = new File(getISResourceLocation()
                ...
                + "jwt-token-signature-algo-none-identity.xml");
