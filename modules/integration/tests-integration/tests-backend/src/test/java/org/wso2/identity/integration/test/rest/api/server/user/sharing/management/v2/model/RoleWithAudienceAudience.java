...
/**
 * The audience for a role assignment, identifying the application or organization that the role belongs to.
 */
public class RoleWithAudienceAudience {
    ...
    @ApiModelProperty(example = "App 1", required = true,
            value = "The display name of the audience (application name or organization name).")
    ...
    @ApiModelProperty(example = "application", required = true,
            value = "The audience type. Either \"application\" or \"organization\".")
    @JsonProperty("type")
    @Valid
    ...
    public boolean equals(Object o) {
        ...
        RoleWithAudienceAudience that = (RoleWithAudienceAudience) o;
