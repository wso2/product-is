...
package org.wso2.identity.integration.test.rest.api.server.organization.management.v2.model;
...
public class OrganizationUpdateRequest {
     ...
     *
     **/
    public OrganizationUpdateRequest displayName(String displayName) {
     ...
     *
     **/
    public OrganizationUpdateRequest description(String description) {
     ...
     *
     **/
    public OrganizationUpdateRequest claims(List<String> claims) {
    ...
    public OrganizationUpdateRequest addClaims(String claim) {
        if (this.claims == null) {
    ...
    public boolean equals(Object o) {
        ...
        OrganizationUpdateRequest scope = (OrganizationUpdateRequest) o;
