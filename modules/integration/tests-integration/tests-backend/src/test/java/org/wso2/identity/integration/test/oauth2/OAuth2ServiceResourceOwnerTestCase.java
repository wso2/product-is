...
public class OAuth2ServiceResourceOwnerTestCase extends OAuth2ServiceAbstractIntegrationTest {
	...
	@Test(dependsOnGroups = "wso2.is", description = "Send authorize user request", dependsOnMethods = "testRegisterApplication")
	...
	@Test(dependsOnGroups = "wso2.is", description = "Send token request with invalid credentials", dependsOnMethods =
    ...
    @Test(dependsOnGroups = "wso2.is", description = "Send token request with invalid consumer secret in Authorization header",
    ...
    @Test(dependsOnGroups = "wso2.is", description = "Send token request with repeating parameter",
            dependsOnMethods = "testRegisterApplication")
	...
	@Test(dependsOnGroups = "wso2.is", description = "Send authorize request for locked user", dependsOnMethods =
