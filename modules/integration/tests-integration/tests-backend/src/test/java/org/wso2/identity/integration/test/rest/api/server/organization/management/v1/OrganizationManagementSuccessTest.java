...
public class OrganizationManagementSuccessTest extends OrganizationManagementBaseTest {
    ...
    public void testAddDiscoveryConfig() throws IOException {
        ...
        String endpointURL1 = ORGANIZATION_CONFIGS_API_BASE_PATH + ORGANIZATION_DISCOVERY_API_PATH;
        Response response1 = getResponseOfDeleteWithOAuth2(endpointURL1, m2mToken);
        validateHttpStatusCode(response1, HttpStatus.SC_NO_CONTENT);
