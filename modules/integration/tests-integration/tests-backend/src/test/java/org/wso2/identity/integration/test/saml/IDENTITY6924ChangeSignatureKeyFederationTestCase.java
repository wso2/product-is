...
public class IDENTITY6924ChangeSignatureKeyFederationTestCase extends AbstractIdentityFederationTestCase {
    ...
    private SAMLSSOServiceProviderDTO getSAMLSSOServiceProviderDTO(String issuerName,
        ...
        samlssoServiceProviderDTO.setDoValidateSignatureInRequests(true);
        if (PRIMARY_IS_SAML_ISSUER_NAME.equals(issuerName)) {
            samlssoServiceProviderDTO.setCertAlias("localhost");
        } else {
    ...
    private void resetISConfiguration() throws Exception {
        log.info("Replacing identity.xml with default configurations & removing additional key stores");
        serverConfigurationManager.restoreToLastConfiguration();
        wso2carbonJKS.deleteOnExit();
    }
