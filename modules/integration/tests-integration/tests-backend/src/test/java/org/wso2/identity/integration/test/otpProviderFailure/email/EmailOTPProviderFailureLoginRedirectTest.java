...
public class EmailOTPProviderFailureLoginRedirectTest extends AbstractOTPProviderFailureTestBase {

    private static final String APP_NAME = "EmailOTPProviderFailureLoginRedirectApp";
    ...
    public EmailOTPProviderFailureLoginRedirectTest(TestUserMode userMode) throws Exception {
    ...
    public void testInit() throws Exception {
        ...
        appId = addTwoStepOIDCApp(APP_NAME, Constants.EMAIL_OTP_AUTHENTICATOR);
