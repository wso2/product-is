...
public final class OAuth2Constant {
    ...
    public final static String ACCESS_TOKEN_ENDPOINT = "https://localhost:9843/oauth2/token";
    public final static String AUTHTOKEN_VALIDATE_SERVICE = "https://localhost:9843/services/OAuth2TokenValidationService";
    public final static String COMMON_AUTH_URL = "https://localhost:9843/commonauth";
    public final static String USER_AGENT = "Apache-HttpClient/4.2.5 (java 1.6)";
    public final static String APPROVAL_URL = "https://localhost:9843/oauth2/authorize";
    public final static String AUTHORIZE_PARAM = "Authorize";
    public final static String TOKEN_VALIDATION_SERVICE_URL = "https://localhost:9843/services/OAuth2TokenValidationService";
