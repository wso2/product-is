...
public class SMSOTPProviderFailureLoginNativeTest extends AbstractOTPProviderFailureTestBase {

    private static final String APP_NAME = "SMSOTPProviderFailureLoginNativeApp";
    ...
    public void testInit() throws Exception {
        ...
        appId = addTwoStepNativeApp(APP_NAME, Constants.SMS_OTP_AUTHENTICATOR);
