...
/**
 * This class tests the pre issue ID token action failure scenarios with password grant type.
 */
public class PreIssueIDTokenActionFailurePasswordGrantTestCase extends ActionsBaseTestCase {
    ...
    public PreIssueIDTokenActionFailurePasswordGrantTestCase(TestUserMode testUserMode, ActionResponse actionResponse,
    ...
    private HttpResponse sendTokenRequestForPasswordGrant() throws IOException {
        ...
        urlParameters.add(new BasicNameValuePair("password", TEST_WSO2));
