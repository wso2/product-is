 ...
 * under the License.
 */
package org.wso2.identity.integration.test.oauth.dcrm.util;

public class OAuthDCRMConstants {
    public static final String CLIENT_CONFIGURATION_ENDPOINT = "https://localhost:9853/identity/register/";
