...
public class CredentialManagementTestBase extends RESTAPIServerTestBase {
    ...
    protected static final String SECONDARY_ORG_USER_ID = "another-org-user-789";
    ...
    /**
     * Make a GET request with OAuth2 token authentication.
     *
     * @param endpoint The API endpoint to call.
     * @param token    The OAuth2 access token.
     * @return The response object.
     */
    protected Response getResponseOfGetWithOAuth2(String endpoint, String token) {
    ...
    /**
     * Make a POST request with OAuth2 token authentication.
     *
     * @param endpoint The API endpoint to call.
     ...
     * @return The response object.
     */
    protected Response getResponseOfPostWithOAuth2(String endpoint, String body, String token) {
    ...
    /**
     * Make a DELETE request with OAuth2 token authentication.
     *
     * @param endpoint The API endpoint to call.
     * @param token    The OAuth2 access token.
     * @return The response object.
     */
    protected Response getResponseOfDeleteWithOAuth2(String endpoint, String token) {
    ...
    /**
     * Make a PUT request with OAuth2 token authentication.
     *
     * @param endpoint The API endpoint to call.
     * @param body     The request body.
     * @param token    The OAuth2 access token.
     * @return The response object.
     */
    protected Response getResponseOfPutWithOAuth2(String endpoint, String body, String token) {
