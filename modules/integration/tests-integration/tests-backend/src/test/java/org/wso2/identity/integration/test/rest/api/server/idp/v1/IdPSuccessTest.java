...
public class IdPSuccessTest extends IdPTestBase {
    ...
    public void testUpdateIdPClaims() throws IOException {
        ...
        response.then()
                ...
                .body("roleClaim.uri", equalTo("groups"));
    }
    ...
    public void testGetIdPClaims() throws IOException {
        ...
        response.then()
                ...
                .body("mappings[1].idpClaim", equalTo("groups"))
                .body("mappings[1].localClaim.id", equalTo("aHR0cDovL3dzbzIub3JnL2NsYWltcy9ncm91cHM"))
                .body("mappings[1].localClaim.uri", equalTo("http://wso2.org/claims/groups"))
                .body("mappings[1].localClaim.displayName", equalTo("Groups"))
