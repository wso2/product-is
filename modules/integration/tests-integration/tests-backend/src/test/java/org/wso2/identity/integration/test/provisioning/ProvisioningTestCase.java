...
public class ProvisioningTestCase extends ISIntegrationTest {
    ...
    private void startOtherCarbonServers() throws Exception {
        ...
        startupParameterMap1.put(PORT_OFFSET_PARAM, CommonConstants.IS_DEFAULT_OFFSET + PORT_OFFSET_1 + "");
        ...
        startupParameterMap2.put(PORT_OFFSET_PARAM, CommonConstants.IS_DEFAULT_OFFSET + PORT_OFFSET_2 + "");
    ...
    private String getSCIMUrl(int portOffset, String baseUrl) {
        return baseUrl.replace("9843/services", String.valueOf(DEFAULT_PORT + portOffset)) + "/wso2/scim/";
    }
}
