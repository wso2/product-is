...
@ApiModel(description = "Indicates that the sharing or unsharing process has started successfully, with the current " +
...
public class ProcessSuccessResponse {
    ...
    @ApiModelProperty(example = "User sharing process triggered successfully.",
            value = "Additional information about the process.")
    ...
    public boolean equals(Object o) {
        ...
        ProcessSuccessResponse that = (ProcessSuccessResponse) o;
