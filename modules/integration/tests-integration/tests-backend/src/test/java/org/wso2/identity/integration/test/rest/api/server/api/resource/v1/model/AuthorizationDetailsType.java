...
public class AuthorizationDetailsType {
    ...
    public AuthorizationDetailsType id(String id) {
     ...
     **/
    public AuthorizationDetailsType type(String type) {
     ...
     **/
    public AuthorizationDetailsType name(String name) {
     ...
     **/
    public AuthorizationDetailsType description(String description) {
     ...
     **/
    public AuthorizationDetailsType schema(Map<String, Object> schema) {
    ...
    public AuthorizationDetailsType putSchemaItem(String key, Object schemaItem) {
    ...
    public boolean equals(Object o) {
        ...
        AuthorizationDetailsType authorizationDetailsType = (AuthorizationDetailsType) o;
        return Objects.equals(this.type, authorizationDetailsType.type) &&
                Objects.equals(this.name, authorizationDetailsType.name) &&
                Objects.equals(this.description, authorizationDetailsType.description) &&
                Objects.equals(this.schema, authorizationDetailsType.schema);
    }
    ...
    public String toString() {
        ...
        sb.append("class AuthorizationDetailsType {\n");
