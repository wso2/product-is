...
//		super.init();
//
//		logManger = new LoginLogoutUtil(backendURL);
...
//		Assert.assertEquals(roles2[0].getItemName(), "testRole",
//		                    "listRoles not including 'testRole' for filter [testRole]");
//	}
//
...
////
////		String value1 = this.logManger.login("user3", "passWord1@", isServer.getBackEndUrl());
...
////
////		String value2 = this.logManger.login("user3", "passwordS1@", isServer.getBackEndUrl());
...
////
////		UserManagementClient userMgtClient1 = new UserManagementClient(isServer.getBackEndUrl(),
////		                                                               "user6", "passWord1@");
