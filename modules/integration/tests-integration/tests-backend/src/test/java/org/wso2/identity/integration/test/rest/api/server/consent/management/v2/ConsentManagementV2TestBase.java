...
public class ConsentManagementV2TestBase extends RESTTestBase {
    ...
    private static final String API_DEFINITION_NAME = "consent-management-v2.yaml";
    private static final String API_PACKAGE_NAME = "org.wso2.carbon.identity.api.server.consent.management.v2";
