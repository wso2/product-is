...
public class OrganizationOAuth2ApplicationManagementSuccessTest extends OrganizationManagementBaseTest {
    ...
    public void testIssueAccessTokenFromSubOrgApplicationFromCCGrant() throws Exception {
        ...
        Assert.assertTrue(Arrays.asList(scopeArray).contains("internal_org_user_mgt_create"));
        Assert.assertTrue(Arrays.asList(scopeArray).contains("internal_org_user_mgt_view"));
        Assert.assertTrue(Arrays.asList(scopeArray).contains("internal_org_user_mgt_update"));
        Assert.assertTrue(Arrays.asList(scopeArray).contains("internal_org_user_mgt_delete"));
    }
