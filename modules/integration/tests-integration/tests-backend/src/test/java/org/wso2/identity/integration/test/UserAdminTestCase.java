...
public class UserAdminTestCase {
    ...
    public void addUser() throws Exception {
        ...
        String[] userList = userAdminStub.listUsers(userName,10);
    ...
    public void addUserWithSpecialCharacters() throws Exception {
        ...
        //check whether user was added successfully
        String[] userList = userAdminStub.listUsers(user,10);
        assertNotEquals(userList.length, 0, "Error in adding user");
    }

    @Test(groups = "wso2.is", dependsOnMethods = "addUserWithSpecialCharacters")
    public void addRoleWithUser() throws Exception {
        userAdminStub.addRole(roleName, new String[]{userName2}, null, false);
        FlaggedName[] roles = userAdminStub.getAllRolesNames("*",100);
    ...
    public void addUserWithRole()
        ...
        FlaggedName[] users = userAdminStub.getUsersOfRole(roleName2, userName3,10);
    ...
    public void addRoleWithUserList() throws Exception {
        userAdminStub.addRole(roleName3, userList, null, false);
        for (String addUser : userList) {
            FlaggedName[] returnedUserList = userAdminStub.getUsersOfRole(roleName3, addUser,10);
    ...
    public void updateUserListOfRole() throws Exception {
        ...
        for (String deletedUser : deletingUsers) {
            FlaggedName[] verifyingList = userAdminStub.getUsersOfRole(roleName4, deletedUser,10);
            assertTrue(!verifyingList[0].getSelected());
        }
        //if all added users are not in list fail
        for (String addingUser : addingUsers) {
            FlaggedName[] verifyingList = userAdminStub.getUsersOfRole(roleName4, addingUser,10);
            assertTrue(verifyingList[0].getSelected());
        }
    }
    ...
    public void addRoleWithUser2() throws Exception {
        userAdminStub.addRole(roleName5, new String[]{userName5}, null, false);
        FlaggedName[] roles = userAdminStub.getAllRolesNames("*", 100);
        for (FlaggedName role : roles) {
    ...
    public void updateRolesOfUser() throws Exception {
        ...
        FlaggedName[] roles = userAdminStub.getRolesOfUser(userName6, "*", 100);
    ...
    public void deleteRole() throws Exception {
        ...
        //verify
        FlaggedName[] existingRoles = userAdminStub.getAllRolesNames("*",100);
    ...
    public void deleteUser() throws Exception {
        ...
        String[] userList = userAdminStub.listUsers(userName6, 100);
