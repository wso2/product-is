...
package org.wso2.carbon.identity.tests.identity.mgt;
...
import org.wso2.carbon.automation.api.clients.identity.mgt.UserInformationRecoveryServiceClient;
...
public class UserInformationRecoveryServiceTestCase extends ISIntegrationTest{
    ...
    public void atEnd() throws Exception {
        ...
        if(nameExists(userMgtClient.getAllRolesNames("umRole11", 100), "umRole11")){
	...
	public void testListUsers() throws Exception {    	
    	Assert.assertTrue(nameExists(userMgtClient.listAllUsers("user11", 100), "user11"), "Listing user with identity mgt enabled has failed.");
	}
