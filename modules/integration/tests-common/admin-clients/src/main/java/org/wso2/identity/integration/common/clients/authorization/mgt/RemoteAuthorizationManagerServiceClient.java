...
import org.wso2.carbon.um.ws.api.stub.RemoteAuthorizationManagerServiceUserStoreExceptionException;
...
public class RemoteAuthorizationManagerServiceClient {
    ...
    public boolean isRoleAuthorized(String roleName, String resourceId, String action) throws RemoteException,
             RemoteAuthorizationManagerServiceUserStoreExceptionException {
        return remoteAuthorizationManagerServiceStub.isRoleAuthorized(roleName, resourceId, action);
    }

    public void clearResourceAuthorizations(String resourceId) throws RemoteException, RemoteAuthorizationManagerServiceUserStoreExceptionException {
        remoteAuthorizationManagerServiceStub.clearResourceAuthorizations(resourceId);
    }

    public void clearAllUserAuthorization(String username) throws RemoteException, RemoteAuthorizationManagerServiceUserStoreExceptionException {
    ...
    public void clearAllRoleAuthorization(String roleName) throws RemoteException, RemoteAuthorizationManagerServiceUserStoreExceptionException {
