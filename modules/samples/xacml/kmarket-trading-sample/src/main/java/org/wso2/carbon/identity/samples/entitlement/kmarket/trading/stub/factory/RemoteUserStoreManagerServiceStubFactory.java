...
public class RemoteUserStoreManagerServiceStubFactory extends BasePoolableObjectFactory {
    ...
    public RemoteUserStoreManagerServiceStubFactory(ConfigurationContext configurationContext, String targetEndpoint,
    ...
    @Override public Object makeObject() throws Exception {
        RemoteUserStoreManagerServiceStub stub = new RemoteUserStoreManagerServiceStub(configurationContext,
                targetEndpoint);
