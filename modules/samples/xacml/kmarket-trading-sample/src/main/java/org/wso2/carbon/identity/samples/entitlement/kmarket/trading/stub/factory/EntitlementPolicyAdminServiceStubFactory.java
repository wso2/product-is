...
public class EntitlementPolicyAdminServiceStubFactory extends BasePoolableObjectFactory {
    ...
    public EntitlementPolicyAdminServiceStubFactory(ConfigurationContext configurationContext, String targetEndpoint,
    ...
    @Override public Object makeObject() throws Exception {
        EntitlementPolicyAdminServiceStub stub = new EntitlementPolicyAdminServiceStub(configurationContext,
                targetEndpoint);
