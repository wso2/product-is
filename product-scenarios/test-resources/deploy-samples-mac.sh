...
wget https://maven.wso2.org/nexus/content/repositories/releases/org/wso2/is/org.wso2.sample.is.sso.agent/5.6.0/org.wso2.sample.is.sso.agent-5.6.0.war
unzip org.wso2.sample.is.sso.agent-5.6.0.war -d travelocity.com
mv travelocity.com apache-tomcat-8.5.35/webapps/

wget https://maven.wso2.org/nexus/content/repositories/releases/org/wso2/is/PassiveSTSSampleApp/5.6.0/PassiveSTSSampleApp-5.6.0.war
unzip PassiveSTSSampleApp-5.6.0.war -d PassiveSTSSampleApp
