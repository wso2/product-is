...
public class UpdateProvisionedUserRoleSCIM1TestCase extends ScenarioTestBase {
    ...
    private String ROLE_NAME = "Engineering";
    ...
    public void createRole() throws Exception {
        ...
        groupObject.put(ROLE_DISPLAY_NAME_ATTRIBUTE, ROLE_NAME);
    ...
    @Test(description = "1.1.2.1.1.15", dependsOnMethods = "createRole")
