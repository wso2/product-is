...
import static org.wso2.identity.scenarios.commons.ScenarioTestBase.IS_HTTPS_URL;
import static org.wso2.identity.scenarios.commons.ScenarioTestBase.setKeyStoreProperties;

/**
 * This test class is to validate when
 * provision a user without authorization headers via SCIM 1.1.
 */
public class ProvisionUserWithoutAuthHeaderTestCase extends ScenarioTestBase {
    ...
    @Test(description = "1.1.2.1.1.5")
    public void testSCIMUserWithoutAuthHeader() throws Exception {

        scimEndpoint = getDeploymentProperties().getProperty(IS_HTTPS_URL) + SCIMConstants.URL_PATH_SEPARATOR + Constants.SCIMEndpoints.SCIM1_ENDPOINT +
                SCIMConstants.URL_PATH_SEPARATOR + Constants.SCIMEndpoints.SCIM_ENDPOINT_USER;
     ...
     */
    private void verifyFilteredUser() throws IOException {
