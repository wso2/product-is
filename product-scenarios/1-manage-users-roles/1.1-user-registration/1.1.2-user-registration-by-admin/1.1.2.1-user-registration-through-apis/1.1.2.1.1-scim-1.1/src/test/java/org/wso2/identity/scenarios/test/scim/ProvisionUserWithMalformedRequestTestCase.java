...
/**
 * This test class is to provision a user
 * with malformed request using SCIM1.1 API.
 */
public class ProvisionUserWithMalformedRequestTestCase extends ScenarioTestBase {
     ...
     * User name attribute is not the required attribute.
     */
    @Test(description = "1.1.2.1.1.2")
    public void testMalformedSCIMUserCreate() throws Exception {

        String USER_NAME_ATTRIBUTE = "Name";
