...
public class ProvisionBulkUsersMalformedRequest extends ScenarioTestBase {
    ...
    @Test(description = "1.1.1.2.9")
    public void testMalformedSCIM2MultipleUsers() throws Exception {
        ...
        assertTrue(
                ((JSONObject) ((JSONArray) ((JSONObject) responseObj).get(SCIMConstants.OPERATIONS_ATTRIBUTE)).get(0))
                        .get(SCIMConstants.STATUS_ATTRIBUTE).toString().contains("400"));
    }
