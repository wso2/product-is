...
public class DeploymentUtil {
    ...
    private static final String PATH_TO_WSO2CARBON_P12 = "keystores/products/wso2carbon.p12";
    ...
    public static void setKeyStoreProperties() {
        ...
        System.setProperty("javax.net.ssl.trustStore", RESOURCE_LOCATION + PATH_TO_WSO2CARBON_P12);
