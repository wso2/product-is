...
package org.wso2.identity.scenarios.commons.clients.application.mgt;
...
public class ApplicationManagementServiceClient {
    ...
    public static final String IDENTITY_APPLICATION_MANAGEMENT_SERVICE = "IdentityApplicationManagementService";
    ...
    public ApplicationManagementServiceClient(String cookie, String backendServerURL,
        ...
        String serviceURL = backendServerURL + IDENTITY_APPLICATION_MANAGEMENT_SERVICE;
     ...
     * @throws Exception
     */
    public void createApplication(String name, String description) throws Exception {
        ServiceProvider serviceProvider = new ServiceProvider();
        serviceProvider.setApplicationName(name);
        serviceProvider.setDescription(description);
        createApplication(serviceProvider);
