...
/**
 * This test class tests the retrieval of self- contained access token when the grant type is password grant.
 */
public class OAuth2SelfContainedTokenPasswordGrantTest extends ScenarioTestBase {
    ...
    @Factory(dataProvider = "oAuth2SelfContainedTokenPasswordGrantConfigProvider")
    public OAuth2SelfContainedTokenPasswordGrantTest(String spConfigFile, String username, String password,
                                                     String tenantDomain) {
    ...
    @DataProvider(name = "oAuth2SelfContainedTokenPasswordGrantConfigProvider")
    private static Object[][] oAuth2SelfContainedTokenPasswordGrantConfigProvider() throws Exception {

        return new Object[][]{
                {
                        "selfcontainedtoken-password-grant.xml", ADMIN_USERNAME, ADMIN_PASSWORD, SUPER_TENANT_DOMAIN
                }
        };
    }
