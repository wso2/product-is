...
/**
 * This test class tests the retrieval of self- contained access token when the grant type is implicit grant.
 */
public class OAuth2SelfContainedTokenImplicitGrantTest extends ScenarioTestBase {
    ...
    @Factory(dataProvider = "oAuth2SelfContainedTokenImplicitGrantTestConfigProvider")
    public OAuth2SelfContainedTokenImplicitGrantTest(String spConfigFile, String username, String password,
                                                     String tenantDomain) {
    ...
    @DataProvider(name = "oAuth2SelfContainedTokenImplicitGrantTestConfigProvider")
    private static Object[][] oAuth2SelfContainedTokenImplicitGrantTestConfigProvider() throws Exception {

        return new Object[][]{
                {
                        "selfcontainedtoken-implicit-grant.xml", ADMIN_USERNAME, ADMIN_PASSWORD,
                        SUPER_TENANT_DOMAIN
                }
        };
    }
    ...
    @Test(description = "9.1.10.3.2", dependsOnMethods = "intiAuthorizeRequest")
