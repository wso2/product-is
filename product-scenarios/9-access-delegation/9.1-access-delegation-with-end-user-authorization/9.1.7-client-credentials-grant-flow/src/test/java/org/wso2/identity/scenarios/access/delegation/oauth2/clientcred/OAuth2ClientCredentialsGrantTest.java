...
package org.wso2.identity.scenarios.access.delegation.oauth2.clientcred;
 ...
 */
public class OAuth2ClientCredentialsGrantTest extends ScenarioTestBase {
    ...
    @Factory(dataProvider = "oAuth2ClientCredentialsGrantConfigProvider")
    public OAuth2ClientCredentialsGrantTest(String dcrRequestFile, String appCreatorUsername, String appCreatorPassword,
            String tenantDomain) {
    ...
    @DataProvider(name = "oAuth2ClientCredentialsGrantConfigProvider")
    private static Object[][] oAuth2ClientCredentialsGrantConfigProvider() throws Exception {

        return new Object[][] {
                {
                        "dcr-request-1.json", ADMIN_USERNAME, ADMIN_PASSWORD, SUPER_TENANT_DOMAIN
                }
        };
    }
    ...
    public void sendTokenRequest() throws Exception {
        ...
        HttpResponse response = oAuth2CommonClient.sendClientCredentialsGrantTokenRequest(clientId, clientSecret, null);
        JSONObject responseJSON = httpCommonClient.getJSONFromResponse(response);
