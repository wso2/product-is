...
/**
 * This test class tests the refresh token retrieval during password grant flow.
 */
public class OAuth2RefreshTokenPasswordGrantTest extends ScenarioTestBase {
    ...
    @Factory(dataProvider = "oAuth2RefreshTokenPasswordGrantConfigProvider")
    public OAuth2RefreshTokenPasswordGrantTest(String dcrRequestFile, String appCreatorUsername, String appCreatorPassword,
    ...
    @DataProvider(name = "oAuth2RefreshTokenPasswordGrantConfigProvider")
    private static Object[][] oAuth2RefreshTokenPasswordGrantConfigProvider() throws Exception {
