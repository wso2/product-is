 ...
 */
public class AdminEditDefaultProfileTest extends SelectDriver {
    ...
    public void editdDefaultProfile() throws Exception {
        ...
        boolean edited = editAdminUserPageAction.updateDefaultProfile(email);
    ...
    @Test(groups = "AdminEditDefaultProfileTest", dependsOnMethods = "editdDefaultProfile")
