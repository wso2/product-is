...
/**
 * Test case to check whether andes rest service bundle started up properly.
 */
@Listeners(PaxExam.class)
@ExamReactorStrategy(PerClass.class)
public class RESTServerStartupTestCase {
    @Inject
    private BundleContext bundleContext;

    /**
     * Creating the OSGi environment with the bundle dependencies needed for andes REST service.
     */
    @Configuration
    ...
    /**
     * Checks if andes rest service bundle is in active.
     */
    @Test
    public void testAndesRestServiceBundle() {
        Bundle coreBundle = getBundle("andes.rest.service");
